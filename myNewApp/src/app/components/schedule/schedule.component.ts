...
@Component({
  ...
  template: ` <app-navbar-admin *ngIf="admin === 'admin'"></app-navbar-admin>
    <app-navbar-student *ngIf="student === 'student'"></app-navbar-student>
    <app-navbar-teacher *ngIf="teacher === 'teacher'"></app-navbar-teacher>
    <br />
    <ejs-schedule
      #scheduleObj
      width="100%"
